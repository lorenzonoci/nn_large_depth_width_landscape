...
python main.py  --arch conv --width_mult $1 --depth_mult $2 --seed $3 --lr $4 --parametr $5 --save_dir=/home/ameterez/work/nips2024/test_after_submission --dataset cifar10  --epochs 300  --layers_per_block $6  --beta 1 --batch_size 256 --logging_steps 100 --warmup_steps 100 --num_workers 16 --top_hessian_eigvals 5 --ntk_eigs 5 --eval_hessian --skip_scaling 0
